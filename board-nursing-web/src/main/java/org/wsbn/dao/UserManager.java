...
public class UserManager
{
    ...
    public synchronized long create(UserDto user)
    {
        if(user == null)
        {
    ...
    public synchronized void delete(UserDto user)
    {
        if(user == null)
        {
    ...
    public synchronized Collection<UserDto> getAllUsers()
    {
        return USERS_TABLE.values();
    }

    public synchronized UserDto getUser(Integer userId)
    {
        return USERS_TABLE.get(userId);
    }

    public synchronized Collection<UserDto> searchUsers(String username)
    {
    ...
    public synchronized void update(UserDto user)
    {
    ...
    protected synchronized long getMaxUserId()
    {

...
public class SchoolDetailsDao implements Serializable

{
	...
	public SchoolDetailsDao() {

	}

	@SuppressWarnings("finally")
	public synchronized SchoolDetailsDto saveEntity(SchoolDetailsDto oDto)
	{
		...
		SchoolDetailsDto oResponse = null;
	...
	public synchronized int deleteEntity(SchoolDetailsDto oDto)
	{
		...
		try {
			...
			Query query = oEm.createQuery("DELETE FROM SchoolDetailsDto e WHERE e.rid = :scholRid");
	...
	public synchronized SchoolDetailsDto addEntity(SchoolDetailsDto oDto)
	{
	...
	public synchronized SchoolDetailsDto find(SchoolDetailsDto pDto)
	{
		...
		return (SchoolDetailsDto) oResponse;

	}

	public synchronized List<SchoolDetailsDto> findAll()
	{

		// get entity manager
		EntityManager oEm = PersistenceManager.createEntityManager();

		List<SchoolDetailsDto> oResponse = null;

		try {

			Query query = oEm.createQuery("SELECT e FROM SchoolDetailsDto e ORDER BY e.year DESC");
	...
	public synchronized SchoolDetailsDto findBySchoolRid(Long schoolRid, int year)
	{
		...
		try {
			...
			sSQL = "SELECT * " + 
			"FROM SCHOOL_DETAILS " +
			"WHERE SCHOOL_RID = " + schoolRid + " " +
			"AND YEAR = " + year   + " ";
		

			//Query query = oEm.createQuery(sSQL);
			// query.setParameter("schoolRid", schoolRid);
			Query query = oEm.createNativeQuery(sSQL, SchoolDetailsDto.class);
			oResponse = (SchoolDetailsDto) query.getSingleResult();
